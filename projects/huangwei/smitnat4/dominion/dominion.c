...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case baron:
		return baronCardEffect(state, choice1, currentPlayer);
    ...
    case minion:
		return minionCardEffect(state, choice1, choice2, handPos, currentPlayer);
    ...
    case tribute:
		return tributeCardEffect(state, nextPlayer, currentPlayer, tributeRevealedCards);
...
/* START custom cardEffect functions */
...
/* END custom cardEffect functions */
